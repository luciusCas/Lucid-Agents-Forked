...
VALUES 
  ('agent_arbitrage_scanner_002', 'ArbitrageBot Pro', 'High-frequency arbitrage detection agent that scans multiple cryptocurrency exchanges for price discrepancies and profitable trading opportunities.', 'https://api.dicebear.com/9.x/adventurer-neutral/svg?seed=Oliver', '[{"name": "MCP", "endpoint": "https://mcp.agent.eth/", "version": "2025-06-18"}]'::jsonb, '["reputation", "tee-attestation", "crypto-economic"]'::jsonb, '0x842d35Cc6634C0532925a3b844Bc9e7595f1bEc', '0x2234567890123456789012345678901234567891', '{"scan_frequency": "real-time", "exchanges": ["binance", "coinbase", "kraken"]}'::jsonb),
  ('agent_gaming_assistant_003', 'GameMaster AI', 'Intelligent gaming assistant for strategy optimization, in-game decision making, and automated gameplay for supported titles.', 'https://api.dicebear.com/9.x/adventurer-neutral/svg?seed=Sarah', '[{"name": "A2A", "endpoint": "https://gaming.agent.io/.well-known/agent-card.json", "version": "0.3.0"}]'::jsonb, '["reputation"]'::jsonb, '0x942d35Cc6634C0532925a3b844Bc9e7595f2bEd', '0x3234567890123456789012345678901234567892', '{"supported_games": ["league_of_legends", "valorant", "chess"], "skill_level": "expert"}'::jsonb),
  ('agent_creative_writer_004', 'ContentCraft AI', 'Professional content generation agent specializing in marketing copy, blog articles, social media posts, and creative writing.', 'https://api.dicebear.com/9.x/adventurer-neutral/svg?seed=Sawyer', '[{"name": "MCP", "endpoint": "https://creative.agent.com/mcp", "version": "2025-06-18"}]'::jsonb, '["reputation", "zkml"]'::jsonb, '0xa42d35Cc6634C0532925a3b844Bc9e7595f3bEe', '0x4234567890123456789012345678901234567893', '{"content_types": ["blog", "marketing", "social_media"], "languages": ["en", "id"]}'::jsonb),
  ('agent_ecommerce_scout_005', 'MarketScout Pro', 'Advanced e-commerce monitoring agent that tracks product prices, availability, reviews, and market trends across major online marketplaces.', 'https://api.dicebear.com/9.x/adventurer-neutral/svg?seed=Easton', '[{"name": "A2A", "endpoint": "https://scout.agent.shop/.well-known/agent-card.json", "version": "0.3.0"}]'::jsonb, '["reputation", "crypto-economic"]'::jsonb, '0xb42d35Cc6634C0532925a3b844Bc9e7595f4bEf', '0x5234567890123456789012345678901234567894', '{"marketplaces": ["amazon", "tokopedia", "shopee"], "update_frequency": "hourly"}'::jsonb);
